   ...
   import java.util.ArrayList;
  	   	...
  	   	/**
  	   	* This program will create a to do list of certain tasks
  	   	* as well as set a priority level and due date to the tasks.
  	   	*
   ...
   public class Task implements ToDoItemInterface, Comparable<Task>
   {
      ...
      private static ArrayList<Task> tasks = new ArrayList<Task>();
      	/** array list with completed task removed. **/
      private static ArrayList<Task> toDoTask = new ArrayList<Task>();
      	/** array list of all completed task objects. **/
   
      private static ArrayList<Task> completedTasks = new ArrayList<Task>();
      	
      	
      	/**
      	* Creates a task object containing a description as
      	* a string, a priority level as an int, and days until
      	* the task is due as an int.
      	*
      	*@param priorityIn - priority level of the task.
      	*@param taskDescriptionIn - description of the task.
      	*@param daysUntilDueIn - days until task is due.
      	**/
      ...
      // if (countObj == 1)
   	...
   	/**
   	* Sends the array list tasks to the ToDoList. 
   	*
   	* @return sends array list task to the ToDoList.
   	**/
      ...
      public static ArrayList<Task> getToDoTask()
      {
         ...
         return toDoTask;
      	...
      	/**
      	* Boolean method that sets the description of the
      	* task unless the description is null, empty, or whitespace.
      	*
      	*@param taskDescriptionIn1 - description of the task.
      ...
      public boolean setDescription(String taskDescriptionIn1)
      {
         ...
         else
         {
      	...
      	/**
      	* Boolean method that sets the priority level and
      	* returns true if the priority level is valid and
      	* returns false otherwise.
      	*
      	*@param priorityIn1 - priority of the task.
      ...
      public boolean setPriority(int priorityIn1)
      {
         ...
         else
         {
      	...
      	/**
      	* Boolean method that sets the category and
      	* returns true if the priority level is valid
      	* and returns false otherwise.
      	*
      	*@param categoryIn - category of the task.
      ...
      public Calendar getDueDate()
      {
         ...
         return Task.calculateDueDate(daysUntilDue);
      	...
      	/**
      	* Takes the days from now that the task is due as an int
      	* and uses that value to set the due date.
      	*
      	*@param daysUntilDueIn - days until the task is due.
      	**/
      ...
      public void specifyDaysUntilDue(int daysUntilDueIn)
      {
         ...
         calculateDueDate(daysUntilDue);
      	...
      	/**
      	* Takes the days from now that the task is due and
      	* returns a Calender object that is specified number
      	* of days from the current date.
      	*
      	*@param dueIn - days until task is due.
      ...
      public static Calendar calculateDueDate(int dueIn)
      {
         ...
         return dateDue;
      	...
      	/**
      	* returns lowest priority that has ever been set as
      	* an int value.
      	*
      ...
      public static int getLowestPriority()
      {
         ...
         return min;
      	...
      	/**
      	* returns the highest priority that has ever been set
      	* as an int value.
      	*
      ...
      public static int getHighestPriority()
      {
         ...
         return min;
      	...
      	/**
      	* returns the task object from all that have ever been created
      ...
      public static Task getEarliestTask()
      {
         ...
         // int j = 0;
            ...
            Task placeHolder = new Task(tasks.get(j).getDescription(),
               tasks.get(j).getPriority(), tasks.get(j).daysUntilDue);
         ...
         else
         {
      	...
      	/**
      	* Returns a string representation of the task in the
      	* correct format.
      	*
      ...
      */
      ...
      public void setComplete(boolean completed)
      {
         ...
         if (completed)
         {
            ...
            toDoTask.remove(this);
         }
         
         if (!completed)
         {
            completedTasks.remove(this);
         }
      }
   ...
   /**
   * Static method that takes a Task parameter and returns true if 
   * the due date of the task is before today and false otherwise. 
   *
   * @param taskIn task object.
   * @return returns true if the due date of the task is 
   *  before today and false otherwise.
   **/
   
      public static boolean isPastDue(Task taskIn)
      {
         Calendar currentDay = Calendar.getInstance();
         Calendar compareTo = taskIn.getDueDate();
         int j = currentDay.compareTo(compareTo);
         boolean k = false;
         if (j > 0)
         {
            k = true;
   	...
   	* Compare to method.
   	*
   	* @param taskIn task to be compared
   	* @return 1 if the value is greater, 0 if they are equal,
   	* -1 if the value is less than.
   	**/
      
      public int compareTo(Task taskIn)
      {
         int j = 0;
         Calendar dateCompared = this.getDueDate();
         Calendar dateComparedTo = taskIn.getDueDate();
         if (dateCompared.before(dateComparedTo))
         {
            j = -1;
         }
         else if (dateCompared.after(dateComparedTo))
         {
            j =  1;
         }
         else if (dateCompared.equals(dateComparedTo))
         {
            j = 0;
         }
