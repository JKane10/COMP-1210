   ...
   public class BombButton extends JButton
   {
      ...
      private Color miss;
      /** icon for an available space. **/
      private ImageIcon unhitPic 
      = new ImageIcon(this.getClass().getResource("unhit.jpg"));
      /** icon for an hit space. **/
      private ImageIcon bombPic 
      = new ImageIcon(this.getClass().getResource("bomb.jpg"));
      /** icon for a missed space. **/
      private ImageIcon emptyPic 
      = new ImageIcon(this.getClass().getResource("empty.jpg"));
