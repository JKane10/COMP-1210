     ...
     **/  
      ...
      public int determineStatus()
      {
         ...
         for (int row = 0; row < grid.length; row++)
         {
            ...
            if (hits < currentShipSpace)
            {
               status = IN_PLAY;
            }
            else if (hits >= currentShipSpace && currentShipSpace != 0)
            {
               status = LOST;
            }
            else
